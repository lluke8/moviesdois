...
class DirectorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create director" do
    assert_difference('Director.count') do
      post directors_url, params: { director: { award: @director.award, birthDate: @director.birthDate, gender: @director.gender, movie: @director.movie, name: @director.name, nationality: @director.nationality } }
    end
  ...
  test "should update director" do
    patch director_url(@director), params: { director: { award: @director.award, birthDate: @director.birthDate, gender: @director.gender, movie: @director.movie, name: @director.name, nationality: @director.nationality } }
